...
const populateOverallPodium = (container, teams) => {
    ...
    sortedTeams.forEach((team, index) => {
        ...
        rankElement.classList.add(index === 0 ? 'second' : index === 1 ? 'first' : 'third');
        ...
        medalElement.src = index === 0 ? 'assets/elements/silver.png' : index === 1 ? 'assets/elements/gold.png' : 'assets/elements/bronze.png';
...
const populateLeaderboard = async ( selectedEvent ) => {
    ...
    populateEventPodium(podiumContainer, [firstTeam, secondTeam, thirdTeam], event);
